...
class TramRow:
    ...
    def __init__(self, tram_frame, tram_number, tram_direction, tram_dep_time):
        ...
        self.numberLabel = Label(self.frame, width=5, textvariable=self.number, font=("default",FONT_SIZE_TRAM), bg = "black", fg="white")
        ...
        self.descrLabel = Label(self.frame, textvariable=self.direction, justify=LEFT, font=("default",FONT_SIZE_TRAM), bg = "black", fg="white")
